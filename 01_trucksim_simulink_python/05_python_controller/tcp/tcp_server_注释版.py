...
from trucksim.trucksim_com import configure_trucksim  # noqa: E402  # 导入 TruckSim 工况配置
...
def main():                                 # 主函数
    ...
    case = parse_case(args.case)            # 解析测试用例
    ...
    if args.config_trucksim:                # 如果启用 TruckSim COM
        ...
        print("CONFIG_SKIP（未启用 TruckSim 工况配置，以当前 simfile 工况为准）", flush=True)  # 提示跳过
